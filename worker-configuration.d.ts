/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3c5f8c80a82e8d53a41ce4c18add9113)
// Runtime types generated with workerd@1.20260515.1 2026-05-02 nodejs_compat
interface __BaseEnv_Env {
	...
	Chat: DurableObjectNamespace<import("./src/Pal").Chat>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/Pal");
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LANGFUSE_SECRET_KEY" | "LANGFUSE_PUBLIC_KEY" | "LANGFUSE_BASE_URL">> {}
}
